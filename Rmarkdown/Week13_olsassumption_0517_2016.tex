...
\usepackage{pgfplots}
\pgfplotsset{width=11cm,compat=1.5}
...
\date{May 17, 2016} %leave out for today's date to be insterted
...
\addplot3 [black, very thick] table {
0 4 0
-0.75 3 0
-1.9 2 0
-1.2 1 0
};
\addplot3 [black, very thick] (axis cs: 0, 0, 0) -- (axis cs:-2,4,0);
%\addplot3 +[scatter, only marks] (axis cs: -4, 1, 0) -- (axis cs:2,1,0);
\addplot3 [only marks] coordinates {(-2.5,1,0) (-2,1,0) (-1.5,1,0) (-1,1,0) 
 (0,1,0)  (0.5,1,0) (1,1,0) (1.5,1,0)} ;
 \addplot3 [only marks, blue] coordinates {(-0.5, 1, 0)} ;
%\addplot3 [black, very thick] (axis cs: -0.75, 3, 0) -- (axis cs:-1.9,2,0);
%\addplot3 [black, very thick] (axis cs: -1.2, 1, 0) -- (axis cs:-1.9,2,0);
\addplot3 [area plot] (x,4,{normal(-1,1)});
\addplot3 [area plot] (x,3,{normal(-0.5,1)}) -- (axis cs:-4,3,0);
\addplot3 [area plot] (x,2,{normal(0,1)}) -- (axis cs:-4,2,0);
\addplot3 [area plot] (x,1,{normal(0,1)}) -- (axis cs:-4,1,0);
\node at (axis cs: -1.2, 0.75, 0 ){\small{+$u_{i}$}} ;
\node at (axis cs: 1.2, 0.75, 0 ){\small{-$u_{i}$}} ;
\end{axis}
\end{tikzpicture}
\end{frame}
...
\begin{axis}[
    ...
    xlabel=X, ylabel=Y,
    zmin=0, zlabel=Probability density of u,
    zlabel style={font=\scriptsize},
    xticklabel style={font=\scriptsize},
    yticklabel style={font=\scriptsize},
    zticklabel style={font=\scriptsize},
...
\addplot3 [black, very thick] (axis cs: -0.75, 3, 0) -- (axis cs:0,4,0);
\addplot3 [black, very thick] (axis cs: -0.75, 3, 0) -- (axis cs:-1.9,2,0);
\addplot3 [black, very thick] (axis cs: -1.2, 1, 0) -- (axis cs:-1.9,2,0);
\addplot3 [area plot] (x,4,{normal(0,1)});
\addplot3 [area plot] (x,3,{normal(0,1)}) -- (axis cs:-4,3,0);
\addplot3 [area plot] (x,2,{normal(-1.9,0.7)}) -- (axis cs:-4,2,0);
\addplot3 [area plot] (x,1,{normal(0,1.5)}) -- (axis cs:-4,1,0);
